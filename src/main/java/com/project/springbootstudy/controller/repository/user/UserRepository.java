package com.project.springbootstudy.controller.repository.user;
...
public interface UserRepository extends JpaRepository<User, String> {
    ...
    // JPQL을 사용한 Update 쿼리
    @Modifying
    @Query("UPDATE User u SET u.name = :name, u.password = :password, u.age = :age, u.gender = :gender, u.phone = :phone, u.homeAddr = :homeAddr WHERE u.userId = :userId")
    void updateUser(@Param("userId") String userId,
                    ...
                    @Param("homeAddr") String homeAddr);
